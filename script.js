...
const seats = [
    ...
    { name: "Wills", party: "lnp", person: "Nswsteamtrainfan10", status: "GAIN", from: "from oth", swing: "100%" },
    { name: "Fraser", party: "lnp", person: "Chris", status: "GAIN", from: "from oth", swing: "100%" },
